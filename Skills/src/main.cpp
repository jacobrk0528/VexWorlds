...
void autonomous(void) {
  ...
  // SKILLS
    // grab goal from platform
      ...
      // place yellow goal on platform
      startLift(12);
      drivePD(720); // drive until lift is all the way up then stop so lift can stop, if need to split into two seperate drive fucntions
      stopLift();
      moveTilter(DOWN);
      moveBackClaw(UP);
      startLift(-12);
      ...
      // grab blue alliance goal from behind bot and score it
      resetDrive();
      startLift(12);
      wait(500, msec);
      stopLift(0);
      ...
      // grab red alliance goal with front
      resetDrive();
      wait(400, msec);
      drivePD(-200);
      turnPD(-105); // turn left
      startLift(-12);
      wait(500, msec);
      drivePD(280);
      startLift(-3);
      ...
      // back up and face middle yellow goal and push it to the oppisit corrner
      resetDrive();
      drivePD(-550);
      startLift(12);
      wait(.5, sec);
      stopLift(0);
      turnPD(-121); // turn left
      stopLift();
      timeDrive(8, 3000);
      drivePD(-400);
      startLift(12);
